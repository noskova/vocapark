...
import 'package:vocapark/src/models/word_to_learn.dart';
import 'package:vocapark/src/new_word/new_word_screen.dart';
...
Future<void> main() async {
  ...
  Hive.registerAdapter(WordToLearnAdapter());

  await Hive.openBox<WordToLearn>('vocabulary');
      ...
      GoRoute(
        ...
        routes: [
          GoRoute(
            path: 'new-word',
            builder: (context, state) =>
                const NewWordScreen(key: Key('new word')),
          ),
          GoRoute(
              path: 'play',
